...
class Db:
    ...
    def create_table(self):
        self.cursor.execute("CREATE TABLE IF NOT EXISTS vectors_files (file_name TEXT,vector text)")
        self.connection.commit()
    
    def insert_table(self):
        self.cursor.execute('SELECT file_name FROM vectors_files')
        ...
        for text in not_added: 
            ...
            query='INSERT INTO vectors_files (file_name,vector) values (%s,%s)'
            time.sleep(30)
    ...
    def search(self,text):
        ...
        self.cursor.execute('SELECT file_name, vector FROM vectors_files')
        rows = self.cursor.fetchall()
